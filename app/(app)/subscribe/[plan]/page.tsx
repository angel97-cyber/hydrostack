...
export default async function SubscribePage({
  ...
  if (!(planParam in PLAN_LIMITS) || !isPaidPlan(planParam)) {
    redirect('/pricing')
  }
  ...
  const waText =
    `Hi Angel, I want to subscribe to HydroStack ${label} ` +
    `(NPR ${priceFormatted}/mo).\n` +
  ...
  return (
    <div className="mx-auto max-w-2xl px-6 py-12 font-sans">
      ...
      <div className="mb-8 border-b border-stone-300 pb-6">
        ...
        <p className="mt-2 font-mono text-lg text-emerald-800">
          NPR {priceFormatted} / month
        </p>
      </div>

      <div className="rounded-sm border border-stone-300 bg-stone-50 p-6 font-mono text-sm text-stone-800">
        <p className="mb-4">
          <span className="font-semibold text-stone-900">Step 1</span>
          {' — Scan the QR code below or pay to:'}
        </p>
        <ul className="ml-6 mb-5 space-y-1">
          <li>
            {'Bank: '}
            <span className="font-semibold text-stone-900">NIC Asia Bank</span>
          </li>
          <li>
            {'Account Name: '}
            <span className="font-semibold text-stone-900">Angel Mainali</span>
          </li>
          <li>
            {'Amount: '}
            <span className="font-semibold text-emerald-800">NPR {priceFormatted}</span>
          </li>
        </ul>
        <p className="mb-5">
          <span className="font-semibold text-stone-900">Step 2</span>
          {' — Take a screenshot of the payment confirmation.'}
        </p>
        <p className="mb-2">
          <span className="font-semibold text-stone-900">Step 3</span>
          {' — Send the screenshot to Angel on WhatsApp or Viber.'}
        </p>
        <p className="ml-6 mb-5 text-stone-600">
          {'Include your registered email: '}
          <span className="font-semibold text-stone-900">{userEmail}</span>
        </p>
        <p className="mb-2">
          <span className="font-semibold text-stone-900">Step 4</span>
          {' — Your plan will be activated within 24 hours.'}
        </p>
        <p className="ml-6 text-stone-600">
      ...
      <div className="my-10 flex flex-col items-center">
        <div className="border border-stone-300 bg-white p-4">
          <Image
            ...
            alt="NIC Asia payment QR"
            width={280}
            height={280}
            priority={true}
          />
        </div>
        <p className="mt-3 font-mono text-xs uppercase tracking-wider text-stone-500">
          NIC Asia Bank
        </p>
      </div>
      ...
      <div className="mt-10 text-center">
        <Link href="/pricing" className="font-mono text-xs text-stone-500 hover:text-stone-800">
          Back to pricing
        </Link>
      </div>
